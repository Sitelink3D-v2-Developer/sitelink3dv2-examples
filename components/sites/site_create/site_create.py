...
def main():
    ...
    # >> Argument handling  
    args = handle_arguments(a_description=script_name, a_arg_list=[arg_log_level, arg_site_owner_uuid, arg_site_name, arg_site_latitude, arg_site_longitude, arg_site_timezone, arg_site_contact_name, arg_site_contact_email, arg_site_contact_phone] )
    # << Argument handling
