...
def main():
    ...
    # >> Argument handling  
    args = handle_arguments(a_description=script_name, a_arg_list=[arg_log_level, arg_site_id, arg_sort_field, arg_sort_order, arg_pagination_page_limit, arg_pagination_start], a_arg_filter_list=["issued_since_epoch","job_type","name","issued_by","status"])
    # << Argument handling
