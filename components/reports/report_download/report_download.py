...
def main():
    ...
    # >> Argument handling  
    args = handle_arguments(a_description=script_name, a_arg_list=[arg_log_level, arg_site_id, arg_report_name, arg_report_url, arg_pagination_page_limit, arg_pagination_start])
    # << Argument handling
