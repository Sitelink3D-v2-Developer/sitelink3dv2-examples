...
def main():
    ...
    # >> Argument handling  
    args = handle_arguments(a_description=script_name, a_arg_list=[arg_log_level, arg_site_id, arg_rdm_operator_code, arg_rdm_operator_first_name, arg_rdm_operator_second_name])
    # << Argument handling
