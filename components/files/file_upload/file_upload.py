...
def main():
    ...
    # >> Argument handling  
    args = handle_arguments(a_description=script_name, a_arg_list=[arg_log_level, arg_site_id, arg_file_name, arg_file_parent_uuid, arg_rdm_domain_default_filesystem])
    # << Argument handling
