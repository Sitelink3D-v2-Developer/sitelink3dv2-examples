...
arg_parser = add_smartview_arguments(arg_parser, "topcon/machines/machine_list")
...
arg_parser = add_site_arguments(arg_parser)
...
sv = SmartView("topcon/machines/machine_list").configure(server.to_url(), args.site_id, header_json)
try:
