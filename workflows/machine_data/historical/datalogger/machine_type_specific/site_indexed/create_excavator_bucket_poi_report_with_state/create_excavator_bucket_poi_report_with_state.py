...
# example is provided specific to excavators. All (low frequency) machine positions along with associated state, position and AsBuilt related flags 
...
# >> Argument handling  
args = handle_arguments(a_description=script_name, a_arg_list=[arg_log_level, arg_site_id, arg_datalogger_start_ms, arg_datalogger_end_ms, arg_datalogger_output_file_name])
# << Argument handling
