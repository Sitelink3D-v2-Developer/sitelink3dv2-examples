...
# >> Argument handling  
args = handle_arguments(a_description=script_name, a_arg_list=[arg_log_level, arg_site_id, arg_smartview_args])
# << Argument handling
...
sv = SmartView("topcon/machines/rds_events").configure(server.to_url(), args.site_id, headers)
try:
